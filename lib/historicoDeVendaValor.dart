...
class Historico_De_Venda_Valor extends StatelessWidget {
  @override
...
class _HomePageState extends State<HistVenda> {
            ...
            children: <Widget>[
              ...
              StreamBuilder(
                  stream: FirebaseFirestore.instance.collection('venda')
                      .orderBy("valor", descending: booleano).snapshots(), // INSTANCIA A COLEÇÃO 'PEDIDO'
                                    ...
                                    children: [
                                      Text('Valor : R\$ ' + collection['valor'].toStringAsFixed(2),
                                        style: TextStyle(color: Colors.brown,
                                            ...
                                            fontSize: 15),),
                                      Text('Data do cadastro : ' +  Timing(collection['mes']),
                                        style: TextStyle(color: Colors.brown,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15),),
                                    ],
  ...
  Timing(String sd){
    new DateFormat('dd/MM/yyyy').parse(sd);
    return new DateFormat('dd/MM/yyyy').parse(sd);
  }
