                          ...
                          child: Container(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Lucro estimado : R\$ ' +
                                      collection['LE'].toStringAsFixed(2),
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 15),
                                ...
                                Text(
                                  'Valor líquido : R\$ ' +
                                      collection['VL'].toStringAsFixed(2),
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 15),
                                ...
                                Text(
                                  'Elástico gasto : ' +
                                      collection['ELAQTD'].toStringAsFixed(2) +
                                      ' cm',
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                ...
                                Text(
                                  'Custo do elástico : R\$ ' +
                                      collection['ELACUS'].toStringAsFixed(2),
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 15),
                                ...
                                Text(
                                  'Tecido gasto : ' +
                                      collection['TECQTD'].toStringAsFixed(2) +
                                      ' cm',
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                ...
                                Text(
                                  'Custo do tecido : R\$ ' +
                                      collection['TECCUS'].toStringAsFixed(2),
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 15),
                                ...
                                Text(
                                  'Estoque do produto : ${collection['ES']}',
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 15),
                                ...
                                Text(
                                  'Data do cadastro : ' + collection['DT'],
                                  style: TextStyle(
                                      color: Colors.brown,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 15),
